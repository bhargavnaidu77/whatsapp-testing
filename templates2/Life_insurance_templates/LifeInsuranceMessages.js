export const interactiveLifeInsuranceMessage = (from) => {
  return {
...
export const termInsuranceGenderMessage = (from) => {
  return {
    messaging_product: "whatsapp",
    to: from,
    type: "interactive",
...
export const termInsuranceDOBMessage = (from) => {
  return {
    messaging_product: "whatsapp",
    to: from,
    type: "text",
...
export const termInsuranceIncomeMessage = (from) => {
  return {
    messaging_product: "whatsapp",
    to: from,
    type: "text",
...
export const termInsuranceSmokerOrDrinkerMessage = (from) => {
  return {
    messaging_product: "whatsapp",
    to: from,
    type: "interactive",
...
export const termInsuranceContactMessage = (from) => {
  return {
    messaging_product: "whatsapp",
    to: from,
    type: "text",
...
export const termInsuranceEmailMessage = (from) => {
  return {
    messaging_product: "whatsapp",
    to: from,
    type: "text",
